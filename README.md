...
网站为纯静态、无构建依赖、无外部 CDN/字体请求，托管于 GitHub Pages（公开仓库 vet-immunology-demo，main 分支根目录），门户 `https://immune-learning-platform.github.io/vet-immunology-demo/`。二维码 = 真实公网 URL 编码的标准 QR（≥1000×1000 PNG、留白充足），禁止 localhost / 本机路径；各章二维码互不相同、各自直达本章页面。
